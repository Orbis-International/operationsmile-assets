function localization_json(){
       return  {
            ...
            "Please enter no more than 60000 characters.": "Please enter no more than 60000 characters.",
        ...
        "zh-TW" : {
            ...
            "Please enter no more than 128 characters.": "請輸入不超過128個字符。",
            "Please enter no more than 60000 characters.": "請輸入不超過60000個字符。",
            "Please enter a valid Email Address.": "請輸入有效的電子郵件地址。"
        },
        "es":{
            "Please fill out this field.": "Por favor rellene este campo.",
            "Please enter the same email address again.": "Vuelva a introducir la misma dirección de correo electrónico.",
        ...
        "de":{
            ...
            "Please enter the same email address again." : "Bitte geben Sie dieselbe E-Mail-Adresse erneut ein.",
        ...
        "zh-CN":{
            ...
            "Please enter the same email address again." : "请再次输入相同的电子邮件地址。",
        ...
        "fr":{
            ...
            "Please enter the same email address again.": "Veuillez saisir à nouveau la même adresse e-mail.",
        ...
        "pt":{
            ...
            "Please enter the same email address again.": "Por favor, insira o mesmo endereço de e-mail novamente.",
        ...
        "ja":{
            ...
            "Please enter the same email address again." : "同じメールアドレスをもう一度入力してください。",
            "Please select an item in the list." : "リストから項目を選択してください。",
            "Please enter no more than 128 characters.": "128文字以内で入力してください。",
            "Please enter no more than 60000 characters.": "60000文字以内で入力してください。",
            "Please enter a valid Email Address.": "有効なメールアドレスを入力してください。"
        },
        "ru":{
            "Please fill out this field."  :   "Пожалуйста, заполните это поле.",
            "Please enter the same email address again."  :   "Пожалуйста, введите тот же адрес электронной почты еще раз.",
        ...
        "ko":{
            ...
            "Please enter the same email address again.": "동일한 이메일 주소를 다시 입력하십시오.",
        ...
        "it":{
            ...
            "Please enter the same email address again." : "Inserisci di nuovo lo stesso indirizzo email.",
        ...
        "vi":{
            ...
            "Please enter the same email address again.": "Vui lòng nhập lại cùng một địa chỉ email.",
            "Please select an item in the list.": "Vui lòng chọn một mục trong danh sách.",
